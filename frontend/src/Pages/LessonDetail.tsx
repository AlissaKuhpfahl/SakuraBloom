...
import type { ModuleKey, LocationState, Module, Step } from "../types";
...
export default function LessonDetail() {
  ...
  const lesson = module?.lessons.find(l => l.id === state.lessonId);
  ...
  function next() {
    ...
    if (stepIndex < steps.length - 1) setStepIndex(v => v + 1);
      ...
      markLessonDone(module.key, lesson.id);
      navigate("/lessons");
    }
  }
  ...
  return (
    <section className="space-y-6 pt-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[420px_1fr]">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-white shadow-md  aspect-4/3">
          ...
          <div
            className={[
              ...
              moduleAccentSoft[state.moduleKey]
            ].join(" ")}
          >
            Level {stepIndex + 1}
          </div>
        ...
        {/* RIGHT: Modul/Lektion Karte (gleiche Breite wie unten links) */}
        <div className="relative overflow-hidden rounded-3xl bg-white p-6 shadow-md">
          <div className={`absolute left-0 top-0 h-2 w-full ${moduleAccent[state.moduleKey]}`} />
      ...
      {/* MAIN: links steps, rechts content */}
      <div className="grid gap-6 lg:grid-cols-[420px_1fr]">
        {/* LEFT: Steps */}
              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    active ? moduleAccentSoft[state.moduleKey] : "bg-(--color-dark-gray)/5",
        ...
        <div className="rounded-3xl bg-white p-6 shadow-md">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              <span className={`h-3 w-3 rounded-full ${moduleAccent[state.moduleKey]}`} />
                  ...
                  return (
                    <button
                      ...
                      className={[
                        ...
                        selected ? moduleAccentSoft[state.moduleKey] : "bg-white"
                      ].join(" ")}
                    >
                      {a}
                    </button>
